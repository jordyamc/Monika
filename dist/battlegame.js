 ...
 */
module.exports = {
    battlegame: (message) => __awaiter(this, void 0, void 0, function* () {
        ...
        function doLure(channel) {
            return __awaiter(this, void 0, void 0, function* () {
                let gameGeneral = yield getGame(channel.id);
        ...
        function doSurrender(channel) {
            return __awaiter(this, void 0, void 0, function* () {
                let players = getPlayers(yield getGame(channel.id));
        ...
        function sendNextTurn(channel, playerId) {
            channel.send(`<@${playerId}> es tu turno!`).then((reactMessage) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (isCommand("test_battle_phase")) {
            ...
            yield doAction(message.channel);
            return;
        }
        if (dbBattle.has(message.channel.id)) { // Continue game
            let gameGeneral = yield dbBattle.get(message.channel.id);
            let gameState = gameGeneral.game;
...
//# sourceMappingURL=battlegame.js.map