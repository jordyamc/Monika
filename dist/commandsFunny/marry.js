...
module.exports = {
    ...
    execute(message, args) {
        ...
        if (!usuario)
            return message.channel.send("Este usuario no existe. Método: `!marry <@usuario/usuarioid>`");
        ...
        collector.on("end", collected => {
            if (collected.size === 0)
                return message.channel.send("Parece que alguien huye del matrimonio :rolling_eyes:");
        });
    }
};
/*
